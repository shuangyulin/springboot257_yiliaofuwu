    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现住址" prop="yonghuAddress">
                       <el-input v-model="ruleForm.yonghuAddress"
                                 placeholder="现住址" clearable  :readonly="ro.yonghuAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="现住址" prop="yonghuAddress">
                           <el-input v-model="ruleForm.yonghuAddress"
